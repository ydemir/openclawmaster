...
const navItems = [
  ...
  { href: "/office", label: "🎮 Ofis", icon: Gamepad2, highlight: true },
  { href: "/actions", label: "Hızlı Eylemler", icon: Zap },
  { href: "/system", label: "Sistem", icon: Server },
  { href: "/logs", label: "Canlı Loglar", icon: Terminal },
  ...
  { href: "/cron", label: "Cron Görevleri", icon: Timer },
