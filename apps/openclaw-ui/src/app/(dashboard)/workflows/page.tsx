...
const WORKFLOWS: Workflow[] = [
  ...
  },
  {
    ...
    description: "Sesión autónoma nocturna que implementa mejoras en Görev Merkezi según el ROADMAP o inventa özelliks nuevas útiles.",
    schedule: "3h (cada noche)",
    trigger: "cron",
    status: "active",
    steps: [
      "Lee ROADMAP.md de Görev Merkezi para seleccionar la siguiente özellik",
      "Si no hay özelliks claras, analiza el estado actual e inventa algo útil",
      "Implementa la özellik completa (código, tests si aplica, UI)",
