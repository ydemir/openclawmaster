    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <p style={{ color: "var(--text-secondary)" }}>Sistem verisi yükleniyor...</p>
        </div>
      </div>
    );
  }
              ...
              <table className="w-full">
                <thead>
                  <tr style={{ borderBottom: "1px solid var(--border)" }}>
                    ...
                    <th className="text-right py-2 px-3 text-sm font-medium" style={{ color: "var(--text-secondary)" }}>Eylemler</th>
                  </tr>
                </thead>
                <tbody>
