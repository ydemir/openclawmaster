    ...
    <div className="p-4 md:p-8">
      ...
      <div className="mb-4 md:mb-6">
        ...
        <p style={{ color: 'var(--text-secondary)', fontSize: '14px' }}>
          Tenacitas ajan aktivitesinin özeti
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
        ...
        >
          ...
          <div className="p-4 grid grid-cols-2 gap-2">
            {[
              { href: "/cron", icon: Calendar, label: "Cron Görevleri", color: "#a78bfa" },
              { href: "/actions", icon: Zap, label: "Hızlı Eylemler", color: "var(--accent)" },
              { href: "/system", icon: Server, label: "System", color: "var(--success)" },
              { href: "/logs", icon: Terminal, label: "Canlı Loglar", color: "#60a5fa" },
              { href: "/memory", icon: Brain, label: "Hafıza", color: "#f59e0b" },
              { href: "/skills", icon: Puzzle, label: "Beceriler", color: "#4ade80" },
